...
INSERT INTO USERS(USERID, USERNAME, PRIMARYEMAIL, PASSWORD, COMMENTS, CREATEDBY, CREATEDDATE, LASTMODIFIEDBY, LASTMODIFIEDDATE)
     VALUES (1, 'barnbarn', 'barnbarn@host.local', '$2y$12$Xno5pFLs07.8kR0RUHfgqOAySbtzGik4Nwr8k60mgW1yyGw1JhL4y', '', 'SYSTEM', CURRENT_TIMESTAMP, 'SYSTEM', CURRENT_TIMESTAMP),
            (2, 'cinnamon', 'cinnamon@host.local', '$2y$12$Xno5pFLs07.8kR0RUHfgqOAySbtzGik4Nwr8k60mgW1yyGw1JhL4y', '', 'SYSTEM', CURRENT_TIMESTAMP, 'SYSTEM', CURRENT_TIMESTAMP),
            (3, 'stumps', 'stumps@host.local', '$2y$12$Xno5pFLs07.8kR0RUHfgqOAySbtzGik4Nwr8k60mgW1yyGw1JhL4y', '', 'SYSTEM', CURRENT_TIMESTAMP, 'SYSTEM', CURRENT_TIMESTAMP);
